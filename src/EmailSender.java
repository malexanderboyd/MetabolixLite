...
public class EmailSender {
	...
	public static boolean sendAttach(String from, String password, String subject, String message, String to[], 
			String email, boolean health, boolean envi, boolean lia, boolean reimbursement) {
		String host = "smtp.gmail.com";
		Properties props = System.getProperties();
